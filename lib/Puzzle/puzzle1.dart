...
import 'package:mathedu/KuisSoal/kuisSoal2.dart';

class Puzzle1Page extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/puzzle1.png', // Gantilah dengan path gambar Anda
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => KuisSoal2()),
                );
