...
import 'package:mathedu/KuisSoal/kuisSoal2v2.dart';

class Puzzle1v2Page extends StatelessWidget {
  @override
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => KuisSoal2v2()),
                );
