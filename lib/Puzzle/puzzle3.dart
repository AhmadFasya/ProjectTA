...
import 'package:mathedu/KuisSoal/kuisSoal4.dart';

class Puzzle3Page extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/puzzle3.png', // Gantilah dengan path gambar Anda
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => KuisSoal4()),
                );
