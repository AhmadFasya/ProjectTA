...
import 'package:mathedu/Puzzle/puzzle1.dart';
import 'package:mathedu/kuis.dart';
import 'package:mathedu/salah.dart';

class KuisSoal1 extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/puzzle-soal1.png'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            Container(
              ...
              child: Image.asset('assets/kuis-soal1.png', fit: BoxFit.contain, // You can adjust BoxFit based on your needs
                height: 200,),
            ),
            Container(
              margin: EdgeInsets.symmetric(horizontal: 35, vertical: 16),
              child: Text(
                "Apa bentuk desimal dari pecahan 3/4?",
              ...
              children: [
                AnswerButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Puzzle1Page()),
                    );
                  },
                ),
                AnswerButton(
