...
import 'package:mathedu/Puzzle/puzzle2.dart';
import 'package:mathedu/kuis.dart';
import 'package:mathedu/salah.dart';

class KuisSoal2 extends StatelessWidget {
  @override
          ...
          children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage('assets/puzzle-soal2.png'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("a. 0,068", style: TextStyle(fontSize: 16)),
                  Text("b. 0,68", style: TextStyle(fontSize: 16)),
                  Text("c. 0,608", style: TextStyle(fontSize: 16)),
                  Text("d. 68", style: TextStyle(fontSize: 16)),
                ],
              ),
            ),
            SizedBox(
              ...
              children: [
                ...
                AnswerButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Puzzle2Page()),
                    );
                  },
                ),
              ],
